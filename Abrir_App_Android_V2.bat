...
echo Iniciando o app Android V2 em modo LAN na porta %EXPO_PORT%...
echo O computador e o smartphone precisam estar na mesma rede Wi-Fi.
echo No login da V2, use a URL do servidor de assinatura deste computador.
